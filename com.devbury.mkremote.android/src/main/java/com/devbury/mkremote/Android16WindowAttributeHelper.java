...
public class Android16WindowAttributeHelper extends Android15WindowAttributeHelper {
        ...
        if (on) {
            ...
            try {
                if (d instanceof BitmapDrawable) {
                    ...
                    BitmapDrawable croped = new BitmapDrawable(c.getResources(), Bitmap.createBitmap(bd.getBitmap(),
                            (int) ((d.getMinimumWidth() - scaledWidth) / 2), 0, scaledWidth, d.getMinimumHeight()));
